...
- **Deferred:** >10k simultaneous I/O operations in a single fan-out needs an async
  interpreter (see docs/INTERPRETE-ASYNC.md). The current thread-pool model covers the
  realistic range.
